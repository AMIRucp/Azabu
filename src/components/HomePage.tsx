...
function StatCard({ label, value, subValue, variant }: { 
  ...
  const valueColor = variant === "positive" ? "#22C55E" : variant === "warning" ? "#D4A574" : "#E6EDF3";
  ...
  return (
    <div 
      ...
      style={{
        padding: "16px 18px",
        borderRadius: 12,
        background: "linear-gradient(145deg, #0A0E13, #080B0F)",
    ...
    >
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          {icon.type === "img" ? (
            ...
            <div style={{ width: 28, height: 28, borderRadius: "50%", background: `${position.color}20`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 700, color: position.color }}>{icon.value}</div>
          )}
          <span style={{ fontSize: 14, fontWeight: 600, color: "#E6EDF3", fontFamily: MONO }}>{position.pair}</span>
        </div>
        <span style={{
          fontSize: 10,
          fontWeight: 700,
          padding: "4px 8px",
          borderRadius: 6,
          background: position.side === "LONG" ? "rgba(34,197,94,0.15)" : "rgba(239,68,68,0.15)",
      ...
      <div style={{ fontSize: 11, color: "#6B7280", fontFamily: MONO, marginBottom: 8 }}>
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 4 }}>
        <div style={{ fontSize: 10, color: "#6B7280", fontFamily: MONO }}>{perp.pair}</div>
        <span style={{
          fontSize: 12,
          fontWeight: 600,
          color: isPositive ? "#22C55E" : "#EF4444",
      ...
      <div style={{ fontSize: 18, fontWeight: 700, color: "#E6EDF3", fontFamily: SANS, marginBottom: 4 }}>
        {perp.name}
      </div>
      ...
      <span style={{
        ...
        padding: "3px 8px",
        borderRadius: 4,
        background: perp.tag === "CRYPTO" ? "rgba(34,197,94,0.15)" : "rgba(212,165,116,0.15)",
        color: perp.tag === "CRYPTO" ? "#22C55E" : "#D4A574",
        fontFamily: MONO,
        marginBottom: 12,
      }}>
        {perp.tag}
      ...
      <div style={{ fontSize: 10, color: "#6B7280", fontFamily: MONO, marginBottom: 12 }}>
        UP TO {perp.leverage} LEVERAGE
      </div>
      
      <div style={{ height: 40, marginBottom: 12 }}>
        <MiniSparkline color={perp.color} seed={perp.symbol.length} trend={isPositive ? "up" : "down"} />
      </div>
      
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div>
          <div style={{ fontSize: 9, color: "#4A5060", fontFamily: MONO }}>VOL</div>
          <div style={{ fontSize: 12, color: "#9BA4AE", fontFamily: MONO }}>${perp.vol}</div>
        </div>
        <div>
          <div style={{ fontSize: 9, color: "#4A5060", fontFamily: MONO }}>OI</div>
        ...
        >
          Trade <ChevronRight style={{ display: "inline", width: 14, height: 14, verticalAlign: "middle", marginLeft: 2 }} />
        </button>
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 12, flex: 1, minWidth: 0 }}>
        {icon.type === "img" ? (
          <img src={icon.value} alt={mover.symbol} style={{ width: 32, height: 32, borderRadius: "50%" }} />
        ) : (
          <div style={{ width: 32, height: 32, borderRadius: "50%", background: `${mover.color}20`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 700, color: mover.color }}>{icon.value}</div>
        )}
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <span style={{ fontSize: 14, fontWeight: 600, color: "#E6EDF3", fontFamily: SANS }}>{mover.pair}</span>
          </div>
      ...
      <div style={{ textAlign: "right", marginRight: 24, width: 70 }}>
        <span style={{
          fontSize: 13,
          fontWeight: 600,
          color: isPositive ? "#22C55E" : "#EF4444",
      ...
      <button
        ...
        onMouseLeave={e => e.currentTarget.style.background = "rgba(255,255,255,0.06)"}
      >
        Trade <ChevronRight style={{ display: "inline", width: 14, height: 14, verticalAlign: "middle" }} />
      </button>
    </div>
  );
}
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <span style={{ fontSize: 13, color: "#9BA4AE", fontFamily: SANS }}>{"Today's PnL"}</span>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <span style={{ fontSize: 13, fontWeight: 600, color: "#D4A574", fontFamily: MONO }}>26.6%</span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 10, fontWeight: 600, color: "#6B7280", fontFamily: MONO, letterSpacing: "0.08em", marginBottom: 12 }}>
          MY RANK
        </div>
        ...
        <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", marginBottom: 8 }}>
          <div>
            ...
            <div style={{ fontSize: 36, fontWeight: 700, color: "#E6EDF3", fontFamily: MONO, letterSpacing: "-0.02em" }}>#14</div>
          </div>
          <div style={{ textAlign: "right" }}>
            <span style={{ fontSize: 18, fontWeight: 700, color: "#8B5CF6", fontFamily: MONO }}>3,240 XP</span>
        ...
        <div style={{ height: 4, background: "rgba(255,255,255,0.08)", borderRadius: 2, marginBottom: 20 }}>
          <div style={{ height: "100%", width: "60%", background: "linear-gradient(90deg, #8B5CF6, #A78BFA)", borderRadius: 2 }} />
        </div>
      ...
      <div style={{ display: "flex", gap: 32 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{
            ...
            <StatCard label="Today's PNL" value="+$384.20" subValue="+1.57%" variant="positive" />
            <StatCard label="Unrealised PNL" value="+$56.20" subValue="3 open positions" variant="positive" />
            <StatCard label="Available Margin" value="$18,240" subValue="73.4% free" />
            <StatCard label="Margin Ratio" value="26.6%" subValue="Healthy" variant="warning" />
          </div>
          
          {/* Open Positions */}
          <div style={{ marginBottom: 32 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
              <h2 style={{ fontSize: 16, fontWeight: 700, color: "#E6EDF3", fontFamily: SANS }}>Open Positions</h2>
              <button
          ...
          <div style={{ marginBottom: 32 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
              <h2 style={{ fontSize: 16, fontWeight: 700, color: "#E6EDF3", fontFamily: SANS }}>Trending Perpetuals</h2>
              <button
          ...
          <div style={{ marginBottom: 32 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16, flexWrap: "wrap", gap: 12 }}>
              <h2 style={{ fontSize: 16, fontWeight: 700, color: "#E6EDF3", fontFamily: SANS }}>{"Today's Movers"}</h2>
                ...
                {[
                  ...
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 8,
                      border: "none",
                      background: moversTab === tab.id ? "rgba(255,255,255,0.1)" : "transparent",
                  ...
                  >
                    {tab.label} {tab.id === "all" && <ChevronRight style={{ display: "inline", width: 12, height: 12, verticalAlign: "middle" }} />}
                  </button>
                ))}
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ width: 100, fontSize: 11, fontWeight: 600, color: "#6B7280", fontFamily: MONO, textTransform: "uppercase", textAlign: "right", marginRight: 24 }}>Price</div>
                <div style={{ width: 70, fontSize: 11, fontWeight: 600, color: "#6B7280", fontFamily: MONO, textTransform: "uppercase", textAlign: "right", marginRight: 24 }}>24H %</div>
                <div style={{ width: 80 }} />
              </div>
