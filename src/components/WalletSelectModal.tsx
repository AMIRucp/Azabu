...
export function WalletSelectModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    ...
    >
      {/* Backdrop with blur */}
      <div className="absolute inset-0 bg-black/60 backdrop-blur-sm pointer-events-auto" onClick={onClose} style={{ top: "44px" }} />

      {/* Relative wrapper to position images against modal */}
